    ...
    <>
      ...
      <div style={{background: 'linear-gradient(to top, #2e2e2e 77%, #4D4B47)'}}>
        <p className="py-5 my-0 w-50 mx-auto" style={{
          ...
          Hello! I'm Toby Snedeker, a student at NC State University with a major in Computer Science and minor in Brewing Science. I'm passionate about many more things,
